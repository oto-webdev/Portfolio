...
const Hero = () => {
  ...
  const section = useMotionTemplate`0px 4px 24px ${color}`;
  ...
  return (
    <motion.section style={{ backgroundImage }} className="relative grid min-h-screen place-content-center overflow-hidden px-4 py-24 text-gray-200">
      <div className='z-10 flex flex-col items-center text-center'>
        ...
        <h1 className='max-w-3xl bg-gradient-to-br bg-clip-text from-white to-gray-400 font-black leading-tight text-transparent md:text-7xl text-3xl'>Oto Ramishvili</h1>
